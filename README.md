...
* CvShortlist.SelfHosted - the self-hosted, stripped down, web application, with only the two AI engines as Azure Cloud dependencies
...
* Azure Cloud (SQL Database, Blob Storage, Document Intelligence, OpenAI, Communication Services, Application Insights)
* Sqlite
* HTML, CSS, Javascript
...
* Cloud-hosted web application - Document Intelligence, gpt-5-mini Foundry model, Storage Account, SQL Database, Application Insights, Communication Services, Email Communication Services
